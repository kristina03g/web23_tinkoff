    ...
    describe('#Queue', () => {
        ...
        it('методы работают корректно ', () => {
           ...
           // TODO: ваши тесты
            ...
            assert.deepStrictEqual(queue.clear(), []);
            assert.strictEqual(queue.size(), 0);
            assert.deepStrictEqual(queue.push(10), [10])
            assert.deepStrictEqual(queue.push(...[7, 4]), [10, 7, 4]);
            assert.deepStrictEqual(queue.pop(), 10);
        });
    });
});
